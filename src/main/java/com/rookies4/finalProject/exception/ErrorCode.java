...
public enum ErrorCode {
    ...
    // 🔹 과목 관련
    // ----------------------------------------------------
    SUBJECT_NOT_FOUND("SUBJECT_001", "과목을 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    SUBJECT_NAME_DUPLICATE("SUBJECT_002", "이미 존재하는 과목명입니다.", HttpStatus.CONFLICT),

    // ----------------------------------------------------
    // 🔹 제목(문제지) 관련
    // ----------------------------------------------------
    TITLE_NOT_FOUND("TITLE_001", "제목을 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    TITLE_NAME_DUPLICATE("TITLE_002", "이미 존재하는 제목명입니다.", HttpStatus.CONFLICT),

    // ----------------------------------------------------
    // 🔹 문제(Problem) 관련
    // ----------------------------------------------------
    PROBLEM_NOT_FOUND("PROBLEM_001", "문제를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),

    // ----------------------------------------------------
    // 🔹 일정(Schedule) 관련
    // ----------------------------------------------------
    SCHEDULE_NOT_FOUND("SCHED_001", "일정을 찾을 수 없습니다.", HttpStatus.NOT_FOUND), // 🌟 추가
